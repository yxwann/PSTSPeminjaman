        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php while ($barang = mysqli_fetch_array($data)): ?>
                    ...
                    <p class="mb-4"> </p>
                    <form action="proses_update_brg.php" method="post">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Data Barang: <?= $barang['nama_brg'];?> dengan Kode Barang:<?= $barang['kode_brg'];?></h6>
                            </div>
                            <div class="card-body">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" name="kodebarang" class="form-control" id="floatingInput"
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text"  name="kategorii" class="form-control" id="floatingInput"
                                                value="<?php echo $barang['kategori']; ?>">
                                            <label for="floatingInput">Kategori</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input type="text" name="merkk" class="form-control" id="floatingInput"
                                                value="<?php echo $barang['merk']; ?>">
                                            <label for="floatingInput">Merk</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input type="text" name="jumlahh" class="form-control" id="floatingInput"
