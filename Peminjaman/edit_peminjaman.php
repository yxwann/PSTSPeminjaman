  ...
  ?>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="../User/Member/user.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="#" data-target="#modalProfile">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>                            
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#"  data-toggle="modal" data-toggle="modal" data-target="#logoutModal">
                ...
                <?php while ($barang = mysqli_fetch_array($data)): ?>
                    ...
                    <p class="mb-4"> </p>
                    <form action="proses_update_peminjaman.php" method="post">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Data dengan Kode Barang: <?= $barang['kode_brg'];?> 
                               dan Berjumlah: <?= $barang['jumlah'];?></h6>
                            </div>
                            <div class="card-body">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="datetime-local" name="tgl_pinjam" class="form-control" id="floatingInput"
                                                value="<?php echo $barang['tgl_pinjam']; ?>">
                                            <label for="floatingInput">Tanggal Pinjam</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input type="datetime-local"  name="tgl_kembail" class="form-control" id="floatingInput"
                                                value="<?php echo $barang['tgl_kembail']; ?>">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" name="kode_brg" class="form-control" id="floatingInput"
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" name="keperluan" class="form-control" id="floatingInput"
                                                value="<?php echo $barang['keperluan']; ?>">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" name="id_login" class="form-control" id="floatingInput"
                                                value="<?php echo $barang['id_login']; ?>">
                                            <label for="floatingInput">ID_LOGIN</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
