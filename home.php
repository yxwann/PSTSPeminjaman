...
<?php
  ...
  if ($_SESSION['role'] != "Admin" ){
    echo'<script>alert("Username Yang Anda Masukan telah terDaftar");</script>';
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                 ...
                                                 $totalBarangQuery = $conn->query("SELECT COUNT(*) FROM barang");
                                                 if ($totalBarangQuery) {
                                                     $totalBarang = $totalBarangQuery->fetch_row()[0];
                                                     echo " $totalBarang";
                                                 } else {
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Banyak Peminjaman</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                 require_once("database.php");
                                                 $totalpinjamQuery = $conn->query("SELECT COUNT(*) FROM peminjaman");
                                                 if ($totalBarangQuery) {
                                                     $totalBarang = $totalpinjamQuery->fetch_row()[0];
                                                     echo " $totalBarang";
                                                 } else {
                                                     echo "Error: " . $conn->error;
                                                 }
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                 require_once("database.php");
                                                 $totaluserQuery = $conn->query("SELECT COUNT(*) FROM user");
                                                 if ($totalBarangQuery) {
                                                     $totalBarang = $totaluserQuery->fetch_row()[0];
                                                     echo " $totalBarang";
                                                 } else {
                                                     echo "Error: " . $conn->error;
                                                 }
